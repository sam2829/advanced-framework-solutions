      ...
      <MainSectionDiv>
        <Container className="pt-5">
          <p className={styles.Text}>
            ...
            project. No job is too big or too small, and we value the
            opportunity to support each client's needs. Please feel free to
            reach out with any enquiry, concerns, or upcoming projects - we'd be
            happy to help.
          </p>
          {/*import contact form  */}
          <ContactForm />
